      ...
      <div className='bg-[#2C3140] min-h-screen font-one text-white p-16 text-xl'>
        ...
        <div className='pl-3 pr-3 text-justify '>
          ...
          <p className='indent-20'>
            Our text summarizer is based on state-of-the-art machine learning techniques. It can summarize texts of any length, from short news articles to long research papers. It can also be used to summarize different types of texts, including news articles, scientific papers, blog posts.
            Our goal is to develop a text summarizer that is accurate, reliable,minimal, and easy to use. We want our text summarizer to be a valuable tool for students, researchers, professionals, and anyone else who needs to quickly understand the main points of a long text.
          </p>
          <br />
          <p className='indent-20'>
