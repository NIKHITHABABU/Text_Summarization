...
const Login = () => {
  ...
  const loginpageprops = useSpring({
    from: { opacity: 0 },
    to: { opacity: 1 },
    config: { duration: 500 },
  });
      ...
      <div className="h-screen font-one  bg-gradient-to-b from-[#99ccff] to-black  ">
        <section class="bg-gray-50 dark:bg-gray-900">
          <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <animated.div style={loginpageprops} class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-2" action="#">
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="text-sm font-medium text-primary-600 hover:underline dark:text-blue-500">
                      Forgot password ?
                    </a>
                  </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    <Link to="/auth/signup" class="font-medium text-primary-600 dark:text-primary-500">
